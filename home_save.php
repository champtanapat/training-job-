...
switch ("cahp") {
    ...
    case 'id':
        ?>
				<tr><th><input type="submit" name="filter" value="ID" class="btn btn-link" > </th>
				<th><input type="button" name="filter" value="Action" class="btn btn-link"> </th>
				<?php break;?>

				<?php case 'detail': ?>
				<th><input type="submit" name="filter" value="Detail" class="btn btn-link"></th>
				<th><input type="button" name="filter" value="Action" class="btn btn-link"></th>
				<?php break;?>

				<?php case 'freeSpace': ?>
					<th><input type="submit" name="filter" value="Free_Space " class="btn btn-link"></th>
					<th><input type="button" name="filter" value="Action" class="btn btn-link" onclick=""></th>

				<?php case 'warranty': ?>
					<th><input type="submit" name="filter" value="Warranty" class="btn btn-link"> </th>
					<th><input type="button" name="filter" value="Action" class="btn btn-link"> </th>
				<?php break;?>

				<?php //case 'Choose..':

    default:showTableAll();
        break;?>
			<?php
}
